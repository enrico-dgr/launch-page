...
import { emulate, goto as gotoDeps, keyboard, setUserAgent, waitFor$x } from 'src/dependencies';
import * as WT from 'src/index';
import { getPropertiesFromSettingsAndLanguage, Languages } from 'src/settingsByLanguage';
import { click, getInnerText, getProperty } from 'WebTeer/elementHandle';
...
const settingsByLanguage = getPropertiesFromSettingsAndLanguage<
  ...
  SettingsOfInstagram
>((sets) => ({
  xpathOfInputForId: sets.notLoggedInPage.elements.inputForId.XPath,
  xpathOfInputForPassword: sets.notLoggedInPage.elements.inputForPassword.XPath,
  xpathOfButtonToLogin: sets.notLoggedInPage.elements.buttonToLogin.XPath,
